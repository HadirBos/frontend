...
const BASE_URL = import.meta.env.VITE_API_URL || "http://localhost:5000/api/submissions"
const FILE_URL = import.meta.env.VITE_API_URL || "http://localhost:5000/api/files"
